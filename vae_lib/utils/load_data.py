...
def load_static_mnist(args, debug=False, **kwargs):
    """
    ...
    train_loader = data_utils.DataLoader(train, batch_size=args.batch_size, shuffle=True and not debug, **kwargs)
...
def load_dataset(args, debug=False, **kwargs):

    if args.dataset == "mnist":
        train_loader, val_loader, test_loader, args = load_static_mnist(args, debug=debug, **kwargs)
